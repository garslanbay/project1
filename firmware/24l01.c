...
const uint8_t TX_ADDRESS[2][TX_ADR_WIDTH]={{0xE7,0xE7,0xE7,0xE7,0xE7},{0x66,0x66,0x66,0x66,0x66}}; //发送地址
...
void NRF24L01_RX_Mode(void)
{
  	...
  	NRF24L01_Write_Reg(WRITE_REG_NRF+RF_SETUP,0x06);//设置TX发射参数,0db增益,2Mbps,低噪声增益开启   
